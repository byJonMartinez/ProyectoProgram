...
import javax.swing.JPanel;
	...
	public class InterfazTablero extends JFrame{
		...
		private InterfazTablero() {
				//String user =JOptionPane.showInputDialog("Introduce tu Nick", "");
				...
				button.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						if(facil){
							...
							BotonInterfaz i = new BotonInterfaz(7, 10);
							...
							BotonInterfaz i = new BotonInterfaz(10, 15);
							getContentPane().remove(1);
							getContentPane().add(i, BorderLayout.CENTER);
							setSize(350, 350);
							setResizable(false);
							...
							BotonInterfaz i = new BotonInterfaz(12, 25);
							getContentPane().remove(1);
							getContentPane().add(i, BorderLayout.CENTER);
							setSize(500, 375);
							setResizable(false);
